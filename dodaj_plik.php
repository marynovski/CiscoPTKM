...
<?php
					 ...
					 else
					 {
								...
								echo '<form method="post" action="add_file.php">';
								echo 'ID:<br /> <input  type="text" name="id-pliku" /><br /><br />';
								echo 'Nazwa:<br /> <input  type="text" name="nazwa" /><br /><br />';
								echo 'Opis:<br /> <input type="text" name="opis" /><br /><br />';
								echo 'Kategoria:<br /> <input type="text" name="kategoria" /><br /><br />';
								echo 'Scieżka:<br /> <input type="text" name="sciezka"  /><br /><br />';
